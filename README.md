...
The mod has not been tested on other devices. It should work on anything that
runs gen1recomp, but behavior on other screens, aspect ratios, or launcher
...
1. Copy the zip and install through mod manager OR copy the extracted folder into your mods directory.
2. Enable the mod in the launcher's MODS panel.
3. Launch any supported game.

## Credits

Borders and mod by BrazilKing.# SGB/GBC Classic
